...
$delegatedFormName = "AD Account - Move"
$delegatedFormGuid = ""
...
'@;
            ...
            variables = @(@{name = "ou"; value = "{{form.ou.Path}}"; typeConstraint = "string"; secret = "False"},
